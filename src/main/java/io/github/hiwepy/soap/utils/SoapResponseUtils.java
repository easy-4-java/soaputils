 ...
 * the License.
 */
package io.github.hiwepy.soap.utils;
...
import io.github.hiwepy.soap.SoapUtils;
import io.github.hiwepy.soap.SoapVersion;
			...
			for (int i = 0; i < methodNodes.getLength(); ++i) {
				...
				if (methodNode.getNodeType() == Node.ELEMENT_NODE) {
					...
					for (int j = 0; j < resultNodes.getLength(); j++) {
						...
						// At Least One Result
						if ( SoapXmlUtils.countChildElementsOfType(resultNode, Node.ELEMENT_NODE) > 0) {
